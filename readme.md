#### Laravel-Auth-Upgraded is an extension of the Laravel Authentification providing User Activation, Roles, Change Password and many more to come(check issues page).
